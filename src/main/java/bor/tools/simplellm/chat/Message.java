...
public class Message {
	...
	/**
	 * Metadata about web search results associated with this message.
	 * <p>
	 * This field is populated when the message is generated by a web search-enabled
	 * model (e.g., Perplexity AI). It contains citations, search results, related
	 * questions, and other search-specific information.
	 * </p>
	 * <p>
	 * This field is null for messages that are not generated from web searches.
	 * </p>
	 *
	 * @see SearchMetadata
	 */
	...
	/**
	 * Checks if this message has associated search metadata.
	 * <p>
	 * This is a convenience method to determine if the message was generated
	 * from a web search and contains citations, search results, or related information.
	 * </p>
	 *
	 * @return true if search metadata is present, false otherwise
	 */
	@JsonIgnore
