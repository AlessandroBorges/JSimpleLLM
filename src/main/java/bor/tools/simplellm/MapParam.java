...
public class MapParam extends LinkedHashMap<String, Object> {
    ...
    public MapParam temperature(Double value) { put("temperature", value); return this; }
    public MapParam maxTokens(Integer value) { put("max_tokens", value); return this; }
    public MapParam model(String value) { put("model", value); return this; }
